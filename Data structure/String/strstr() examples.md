# strstr(): Find a first part and second part of a string splitted by a substring 
...
# strstr(): Split a string by substring
...
# strstr(): Replace substring inside a string
