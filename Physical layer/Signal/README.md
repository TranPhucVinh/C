...
* [SIGSEGV](Working%20with%20specific%20signals.md#sigsegv): Memory access violation, e.g trying to read or write from/to a memory area that your process does not have access to.
* SIGPIPE
* SIGALRM
* SIGSTKFLT
