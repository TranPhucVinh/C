...
//Must Telegram, the host must have https
char host[] = "https://api.telegram.org/bot1284804357:AAHRiRkFpUL6rRsQVO10iRQ485uwqrHLFaE/sendMessage";
char message[] = "{\"chat_id\": 998576382,\"text\": \"lib curl\"}";
